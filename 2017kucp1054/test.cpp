...
// For creating sphere from circle
...
int main()
{
    ...
    my_circle(50, 50, 25);
    // Code section for horizontal projectile motion
    float t = 1;
    float h = 100;
    float v = 10;
    float xx = v*t;
    ...
    // code section for bounce for first half
    h = h/2;
    v = v/2;
    t = 1;
    float theta = 0.52;
    ...
    // code section for bounce for second half
    t = 1;
    h = yy;
    xx += v*t;
    yy += (4.9*t*t);
